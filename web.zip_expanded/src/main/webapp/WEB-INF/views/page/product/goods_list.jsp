												...
												<div class="modal-dialog modal-lg">
													<div class="modal-content">
															...
															<form action="/page/product/modify">
																<div class="col-md-6">
																	<div class="form-group">
																		...
																		<input type="text" class="form-control" id="pName_${product.pNo }"
																			name="pName" value="${product.pName }" placeholder="상품명">
																	</div>
																</div>
																<div class="col-md-6">
																	<div class="form-group">
																		...
																		<input type="text" class="form-control" id="pCode"
																			name="pCode" value="${product.pCode }" placeholder="자동생성">
																	</div>
																</div>
																<div class="col-md-6">
																	<div class="form-group">
																		...
																		<input type="text" class="form-control" id="pPrice"
																			name="pPrice" value="${product.pPrice }" placeholder="가격">
																	</div>
																</div>
																<div class="form-group col-md-6">
																	...
																	<div class="form-inline">
																		<input type="text" class="form-control" id="pBrand"
																			name="pBrand" value="${product.pBrand }" placeholder="브랜드를 선택해주세요"> <select
																...
																<div class="col-md-6">
																	<div class="form-group">
																		...
																		<input type="text" class="form-control" id="pStock"
																			name="pStock" value="${product.pStock }" placeholder="재고">
																	</div>
																</div>
																<div class="form-group col-md-6">
																	<label for="pColor" class="control-label">색상:</label>
																	<div class="form-inline">
																		<input type="text" id="pColor" name="pColor" value="${product.pColor }"
																...
																<div class="col-md-6">
																	<div class="form-group">
																		<label for="pSize" class="control-label">사이즈:</label><small
																			...
																			id="pSize" name="pSize" value="${product.pSize }" placeholder="사이즈를 입력 해주세요">
																...
																<div class="form-group col-md-6">
																	...
																	<div class="form-inline">
																		<input type="text" class="form-control" id="pMaterial"
																			name="pMaterial" value="${product.pMaterial }" placeholder="소재를 선택해주세요"> <select
																...
																<div class="form-group col-md-6">
																	...
																	<div class="form-inline">
																		<input type="text" class="form-control" id="pMaker"
																			name="pMaker" value="${product.pMaker }" placeholder="제조사를 선택해주세요"> <select
																...
																<div class="col-md-6">
																	<div class="form-group">
																		...
																		<input type="checkbox" class="minimal"
																			id="pCouponUseCheck" name="pCouponUseCheck" value="${product.pCouponUseCheck }">
																	</div>
																</div>
																		...
																		<div class="form-inlie">
																			<div class="col-md-10">
																				...
																				<input type="text" class="form-control" id="pDesc"
																					name="pDesc" value="${product.pDesc }" placeholder="간단한 상품설명을 입력해주세요">
																			</div>
																		</div>
																	</div>
																</div>
														...
														<div class="modal-footer">
															...
															<button type="button" data-pNo="${product.pNo }" class="btn btn-primary btnApply">수정</button>
														</div>
													</div>
													<!-- /.modal-content -->
												</div>
		...
		$(document).ready(function() {
			...
			$(".btnApply").click(function() {
				...
				$.ajax({
					...
					type : "get",
					data : {"pPrice":pPrice,"pName":pName, "pBrand":pBrand, "pStock":pStock, "pColor":pColor, "pSize":pSize, "pMaterial":pMaterial, "pMaker":pMaker, "pDesc":pDesc, "pCouponUseCheck":pCouponUseCheck, "pNo":testPno   },
					success : function(msg) {
						alert("수정 완료");
						location.reload();
					},
