	...
	<nav class="navbar navbar-static-top">
		...
		<div class="collapse navbar-collapse pull-left" id="navbar-collapse">
			<ul class="nav navbar-nav">
				...
				<li><a href="/WEB-INF/views/page/product/goods_list.jsp">상품관리</a></li>
				<li><a href="/WEB-INF/views/page/order/order_list.jsp">주문관리</a></li>
				<li><a href="/WEB-INF/views/page/member/member_list1.jsp">회원관리</a></li>
